...
void motor_instruction_to_string(struct cnc_motor_instruction_struct* instruction, char* string, uint16_t* offset){
    ...
    local_offset++;
    memcpy(&string[local_offset], &instruction->current_position, 8);
...
void string_to_motor_instruction(struct cnc_motor_instruction_struct* instruction, char* string, uint16_t* offset){
    ...
    local_offset++;
    memcpy(&instruction->current_position, &string[local_offset], 8);
    local_offset = local_offset + 8;
...
uint16_t config_to_string(struct cnc_config_struct* config, char* string){
    ...
    offset = offset + 1;
    memcpy(&string[offset], &config->max_speed, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->min_speed, 8);
    offset = offset + 8;
    memcpy(&string[offset], &config->ramp_period, 4);
    offset = offset + 4;
	memcpy(&string[offset], &config->xl_min_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->xr_max_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->yf_min_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->yb_max_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zl_min_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zl_max_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zr_min_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zr_max_safe_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->xl_min_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->xr_max_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->yf_min_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->yb_max_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zl_min_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zl_max_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zr_min_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zr_max_home_pos, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->x_axis_size, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->y_axis_size, 8);
    offset = offset + 8;
	memcpy(&string[offset], &config->zr_axis_size, 8);
    offset = offset + 8;
    memcpy(&string[offset], &config->zl_axis_size, 8);
    offset = offset + 8;
    return offset;
}
void string_to_config(struct cnc_config_struct* config, char* string){
    ...
    offset = offset + 1;
    memcpy(&config->max_speed, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->min_speed, &string[offset], 8);
    offset = offset + 8;
    memcpy(&config->ramp_period, &string[offset], 4);
    offset = offset + 4;
	memcpy(&config->xl_min_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->xr_max_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->yf_min_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->yb_max_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zl_min_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zl_max_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zr_min_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zr_max_safe_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->xl_min_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->xr_max_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->yf_min_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->yb_max_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zl_min_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zl_max_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zr_min_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zr_max_home_pos, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->x_axis_size, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->y_axis_size, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zl_axis_size, &string[offset], 8);
    offset = offset + 8;
	memcpy(&config->zr_axis_size, &string[offset], 8);
	offset = offset + 8;
}
...
uint16_t status_to_string(struct cnc_status_struct* status, char* string){
    ...
    offset = offset + 1;
    memcpy(&string[offset], &status->ex0_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->ex1_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->aux_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->xl_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->yf_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->zl_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->zr_position, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->heater_0_temp, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->heater_1_temp, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->heater_2_temp, 8);
    offset = offset + 8;
	memcpy(&string[offset], &status->heater_3_temp, 8);
    offset = offset + 8;
...
void string_to_status(struct cnc_status_struct* status, char* string){
    ...
    offset = offset + 1;
    memcpy(&status->ex0_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->ex1_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->aux_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->xl_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->yf_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->zl_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->zr_position, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->heater_0_temp, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->heater_1_temp, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->heater_2_temp, &string[offset], 8);
    offset = offset + 8;
	memcpy(&status->heater_3_temp, &string[offset], 8);
    offset = offset + 8;
}
